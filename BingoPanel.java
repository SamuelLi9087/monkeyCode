...
public class BingoPanel extends JPanel implements KeyListener{
	...
	public void paint(Graphics g) {
		...
		g.drawString("Instructions: Press any key to roll the ball.",1000,400);
		g.drawString("In your downloads folder, you will see files of the bingo cards.",1000,600);
		...
		if(bcard.checkWinners()==true) {
			...
			Font regFont2 = new Font("SansSerif", Font.PLAIN, 400);
			g.setFont(regFont2);
			g.drawString("Bingo!",100,500);
